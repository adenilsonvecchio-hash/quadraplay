        ...
        <section className="qp-card rounded-[30px] p-5">
          {completed ? <div className="text-center py-4">
            ...
            <div className="space-y-3">
              <label className="block"><span className="text-[11px] font-black text-slate-500 ml-1">Nova senha</span><div className="relative mt-1.5"><Lock className="w-4 h-4 text-slate-400 absolute left-4 top-1/2 -translate-y-1/2" /><input type="password" value={password} onChange={(event) => setPassword(event.target.value)} className="w-full qp-soft rounded-[18px] pl-11 pr-4 py-3.5 text-sm outline-none focus:ring-2 focus:ring-amber-200" /></div></label>
              <label className="block"><span className="text-[11px] font-black text-slate-500 ml-1">Confirmar nova senha</span><div className="relative mt-1.5"><Lock className="w-4 h-4 text-slate-400 absolute left-4 top-1/2 -translate-y-1/2" /><input type="password" value={confirmation} onChange={(event) => setConfirmation(event.target.value)} className="w-full qp-soft rounded-[18px] pl-11 pr-4 py-3.5 text-sm outline-none focus:ring-2 focus:ring-amber-200" /></div></label>

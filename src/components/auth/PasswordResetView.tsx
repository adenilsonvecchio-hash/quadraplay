  ...
  return (
    <div className="min-h-screen bg-[#eef1f8] flex items-center justify-center px-4 py-7">
      <div className="qp-shell w-full max-w-md rounded-[38px] border border-white p-5 sm:p-7">
        <div className="text-center pt-3 pb-7"><BrandLogo className="justify-center" /><p className="text-sm font-bold text-slate-500 mt-3">Recupere o acesso com segurança.</p></div>
        <section className="qp-card rounded-[30px] p-5">
          {completed ? <div className="text-center py-4">
            <CheckCircle2 className="w-12 h-12 text-emerald-500 mx-auto" />
            <h2 className="text-xl font-black text-[#0b1742] mt-3">Senha atualizada</h2>
            <p className="text-xs text-slate-500 mt-2">Entre novamente usando sua nova senha.</p>
            ...
            <h2 className="text-xl font-black text-[#0b1742]">Criar nova senha</h2>
            ...
            <div className="space-y-3">
              ...
              <button type="button" disabled={saving} onClick={() => void save()} className="qp-primary w-full rounded-[18px] py-3.5 font-black text-sm disabled:opacity-60">{saving ? 'Salvando...' : 'Atualizar senha'}</button>
